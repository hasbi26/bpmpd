...
<head>
    ...
    <meta name="title" content="DPMD | Login Page" />
    <meta name="author" content="ColorlibHQ" />
    <meta name="description" content="DPMD" />
    <meta name="keywords" content="DPMD KABUPATEN SUMEDANG" />
...
<body class="login-page bg-body-secondary" style="background: url('<?= $bgFile ?>') 
    ...
    <div class="login-box">
        <div class="login-logo">
            ...
            <img src="<?= base_url('assets/adminlte/img/') ?>dpmd.png" style="width: 350px;"
                ...
                <form action="<?= base_url('/auth/login') ?>" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="form-check">
                                    <div class="g-recaptcha" data-sitekey="6Lfx7aMrAAAAAPyMnnJCqf4y-i0qc-_hbR353_xq">
                                    </div>
                                </div>
                            </div>
                        </div>
