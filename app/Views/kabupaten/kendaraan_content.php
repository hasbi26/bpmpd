    ...
    <div class="col-12">
        ...
        <div class="card card-outline card-secondary mt-4">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="bi bi-table me-1"></i> Data Aset Kendaraan Seluruh Kecamatan &amp; Desa
                </h3>
                <div class="card-tools">
                    <?php
                        ...
                        $pdfUrl = base_url('kabupaten/aset-kendaraan/export/pdf') . (!empty($pdfQuery) ? '?' . implode('&', $pdfQuery) : '');
                    ?>
                ...
                <div class="row g-2 mb-3">
                    ...
                    <div class="col-auto">
                        <select name="kecamatan_id" id="kecamatan_id" class="form-select"
                                onchange="loadContent('kendaraan', this.value ? { kecamatan_id: this.value } : {})">
                            <option value="">-- Semua Kecamatan --</option>
                            <?php foreach ($kecamatanList as $k): ?>
                                <option value="<?= esc($k['id']) ?>" <?= (string) $selectedKecamatanId === (string) $k['id'] ? 'selected' : '' ?>>
                                    <?= esc($k['nama']) ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="col-auto">
                        <select name="desa_id" id="desa_id" class="form-select"
                                onchange="loadContent('kendaraan', {
