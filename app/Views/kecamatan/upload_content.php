<h3 class="mb-3" id="content-title">Upload Document <?= esc(ucfirst($role)) ?>
                    ...
                    <div class="mb-3">
                        ...
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <button class="nav-link active" id="nav-desa-tab" data-bs-toggle="tab"
                                    data-bs-target="#nav-desa" type="button" role="tab" aria-controls="nav-desa"
                                    aria-selected="true">Desa</button>
                                <button class="nav-link" id="nav-kecamatan-tab" data-bs-toggle="tab"
                                    data-bs-target="#nav-kecamatan" type="button" role="tab"
                                    aria-controls="nav-kecamatan" aria-selected="false">Kecamatan</button>
                            </div>
                        </nav>
                        ...
                        <div class="tab-content mt-3" id="nav-tabContent">
                            <!-- Desa Tab -->
                            <div class="tab-pane fade show active" id="nav-desa" role="tabpanel"
                                aria-labelledby="nav-desa-tab">
                            ...
                            <div class="tab-pane fade" id="nav-kecamatan" role="tabpanel"
                                aria-labelledby="nav-kecamatan-tab">
