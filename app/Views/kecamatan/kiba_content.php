    ...
    <div class="col-12">
        ...
        <div class="card card-outline card-secondary mt-4">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="bi bi-table me-1"></i> Data Aset Tanah Seluruh Desa
                </h3>
                <div class="card-tools">
                    <a href="<?= base_url('kecamatan/aset-tanah/export/pdf') . ($selectedDesaId ? '?desa_id=' . $selectedDesaId : '') ?>"
            ...
            <div class="card-body">
                <form method="get" action="<?= base_url('kecamatan/aset-tanah') ?>" class="row g-2 mb-3">
                    <div class="col-auto">
                        <label for="desa_id" class="col-form-label">Filter Desa:</label>
                    </div>
                    <div class="col-auto">
                        <select name="desa_id" id="desa_id" class="form-select"
                            onchange="loadContent('kiba', this.value ? { desa_id: this.value } : {})">
