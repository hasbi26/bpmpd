...
<style>
    ...
    table.data th, table.data td { border: 1px solid #666; padding: 4px 5px; font-size: 8.5px; vertical-align: top; }
    table.data th { background-color: #2C3E50; color: #fff; text-align: center; }
    table.data td.num { text-align: right; }
    table.data td.center { text-align: center; }
    .ttd-wrapper { margin-top: 40px; width: 100%; }
    .ttd-box { width: 260px; float: right; text-align: center; font-size: 10px; }
...
<body>
    ...
    <table class="data">
        ...
        <tbody>
            <?php if (empty($rows)): ?>
                <tr><td colspan="12" class="center">Belum ada data aset kendaraan.</td></tr>
            <?php else: ?>
